...
class _EditProductScreenState extends State<EditProductScreen> {
  ...
  void didChangeDependencies() {
    if (_isInit) {
      ...
      final String productID = (ModalRoute.of(context)!.settings.arguments).toString().isEmpty ? "" : ModalRoute.of(context)!.settings.arguments.toString();
...
// to save variables by executing the onsaved method of the form fields, be sure to call .save() after successful validation
      ...
      Provider.of<Products>(context, listen: false).updateProducts(newProduct);
